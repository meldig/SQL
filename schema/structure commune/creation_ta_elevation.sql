...
COMMENT ON COLUMN G_GEO.TA_ELEVATION.fid_libelle IS 'Clé étrangère vers la table TA_LIBELLE permettant de distinguer les valeurs d''élévation entre valeur minimum, valeur moyenne, valeur médiane et valeur maximale.';
