/*
Création de la table ta_grille permmettant d''organiser le travail des agents sur le territoire de la MEL. Cette grille est utilisée dans le cadre d'un travail de bureau, par exemple par les photo-interprètes, elle ne l'est pas pour un travail de terrain.
*/
...
-- 6. Création de la séquence d'auto-incrémentation de la clé primaire
