...
CREATE SEQUENCE SEQ_TA_RTGE_POINT_INTEGRATION_LOG_OBJECTID START WITH 1 INCREMENT BY 1;
...
/*
SEQ_TA_RTGE_LINEAIRE_INTEGRATION_OBJECTID : création de la séquence d'auto-incrémentation de la clé primaire de la table TA_RTGE_LINEAIRE_INTEGRATION
*/

CREATE SEQUENCE SEQ_TA_RTGE_LINEAIRE_INTEGRATION_OBJECTID START WITH 1 INCREMENT BY 1;
...
/*
SEQ_TA_PTTOPO_INTEGRATION_OBJECTID : création de la séquence d'auto-incrémentation de la clé primaire de la table TA_PTTOPO_INTEGRATION
*/

CREATE SEQUENCE SEQ_TA_PTTOPO_INTEGRATION_OBJECTID START WITH 1 INCREMENT BY 1;


/*
SEQ_TA_PTTOPO_INTEGRATION_OBJECTID_LOG : création de la séquence d'auto-incrémentation de la clé primaire de la table TA_PTTOPO_INTEGRATION_LOG
*/

CREATE SEQUENCE SEQ_TA_PTTOPO_INTEGRATION_LOG_OBJECTID START WITH 1 INCREMENT BY 1;
...
/*
SEQ_TA_OCSMEL_LINEAIRE : création de la séquence d'auto-incrémentation de la clé primaire de la table TA_OCSMEL_LINEAIRE
*/

CREATE SEQUENCE SEQ_TA_OCSMEL_LINEAIRE_OBJECTID START WITH 1 INCREMENT BY 1;
...
CREATE SEQUENCE SEQ_TA_IC_LINEAIRE_OBJECTID START WITH 1 INCREMENT BY 1;
...
/*
SEQ_TA_RTGE_LINEAIRE_SOMMET_CONSULTATION_OBJECTID : création de la séquence d'auto-incrémentation de la clé primaire de la table TA_RTGE_LINEAIRE_SOMMET
*/

CREATE SEQUENCE SEQ_TA_RTGE_LINEAIRE_SOMMET_CONSULTATION_OBJECTID START WITH 1 INCREMENT BY 1;


/*
SEQ_TA_RTGE_ALTI_CONSULTATION_OBJECTID : création de la séquence d'auto-incrémentation de la clé primaire de la table TA_RTGE_ALTI
*/

CREATE SEQUENCE SEQ_TA_RTGE_ALTI_CONSULTATION_OBJECTID START WITH 1 INCREMENT BY 1;
