...
-- recupere le nom de la sequence
    BEGIN
      ...
      ;
    DBMS_OUTPUT.PUT_LINE('CREATE SEQUENCE SEQ_TA_OCSMEL_LOG INCREMENT BY 1 START WITH ' || NOMBRE_DEPART || ' INCREMENT BY 1 NOCACHE');
    END;
-- execution de la requete
    BEGIN
      EXECUTE IMMEDIATE
      'CREATE SEQUENCE SEQ_TA_OCSMEL_LOG INCREMENT BY 1 START WITH ' || NOMBRE_DEPART || ' INCREMENT BY 1 NOCACHE');
    END;
END;
