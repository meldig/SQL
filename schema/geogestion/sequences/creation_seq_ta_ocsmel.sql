...
-- recupere le nom de la sequence
    BEGIN
      ...
      ;
    DBMS_OUTPUT.PUT_LINE('CREATE SEQUENCE SEQ_TA_OCSMEL INCREMENT BY 1 START WITH ' || NOMBRE_DEPART || ' NOCACHE');
    END;
-- execution de la requete
    BEGIN
      EXECUTE IMMEDIATE
      'CREATE SEQUENCE SEQ_TA_OCSMEL INCREMENT BY 1 START WITH ' || NOMBRE_DEPART || ' NOCACHE';
    END;
END;
