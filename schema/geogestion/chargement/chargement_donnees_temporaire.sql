...
-- 8. Table TA_SUR_TOPO_G_LOG
CREATE TABLE TEMP_TA_SUR_TOPO_G_LOG AS
SELECT * FROM GEO.TA_SUR_TOPO_G_LOG@DBL_CUDL_GEO;


-- 9. Table TA_LIG_TOPO_GPS_BACKUP
CREATE TABLE TEMP_TA_LIG_TOPO_GPS_BACKUP AS
SELECT * FROM GEO.TA_LIG_TOPO_GPS_BACKUP@DBL_CUDL_GEO WHERE GEO_REF NOT LIKE 'IC_';


-- 10. TA_LIG_TOPO_GPS_GEO_ON_VALIDE_1
CREATE TABLE TEMP_TA_LIG_TOPO_GPS_GEO_ON_VALIDE_1 AS
SELECT * FROM GEO.TA_LIG_TOPO_GPS_GEO_ON_VALIDE_1@DBL_CUDL_GEO WHERE GEO_REF NOT LIKE 'IC_';
