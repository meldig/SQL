-- Procédure pour mettre à jour les Z des lignes de la table TA_LIG_TOPO_GPS.
...
Etape de la procédure:
    ...
    10. Mise à jour de la table TA_LIG_TOPO_GPS
*/


CREATE OR REPLACE PROCEDURE MISE_A_JOUR_Z_TA_LIG_TOPO_GPS(NUMERO_DOSSIER NUMBER)
IS
BEGIN
    -- 1. Insertion des données dans la table TA_GG_RECUPERATION_Z_ETAPE_1.
    -- geometrie de chaque ligne en type WKT
    MERGE INTO TA_GG_RECUPERATION_Z_ETAPE_1 a
    USING 
        (
        SELECT
        ...
        FROM
            GEO.TA_LIG_TOPO_GPS a
        WHERE
            a.GEO_REF = 'REC_' || NUMERO_DOSSIER
        )b
    ON (a.OBJECTID_LIGNE = b.OBJECTID_LIGNE)
    WHEN NOT MATCHED THEN 
    INSERT(a.OBJECTID_LIGNE, a.GEO_REF, a.TYPE_WKT_LIGNE_GEOMETRY, a.GEOM)
    VALUES(b.OBJECTID_LIGNE, b.GEO_REF, b.TYPE_WKT_LIGNE_GEOMETRY, b.GEOM)
    ;
    ...
    MERGE INTO TA_GG_RECUPERATION_Z_ETAPE_2 a
    USING 
        (
        SELECT
            a.OBJECTID_LIGNE,
            ...
            END as GEOM
        FROM
            GEO.TA_GG_RECUPERATION_Z_ETAPE_1 a
    ...
    MERGE INTO TA_GG_RECUPERATION_Z_ETAPE_3 a
    ...
    USING 
        ...
        FROM
            GEO.TA_GG_RECUPERATION_Z_ETAPE_2 a
        )b
    ON (a.OBJECTID_LIGNE = b.OBJECTID_LIGNE
    AND a.OBJECTID_ELEMENT_LIGNE = b.OBJECTID_ELEMENT_LIGNE)
    WHEN NOT MATCHED THEN 
    ...
    MERGE INTO TA_GG_RECUPERATION_Z_ETAPE_4 a
    USING 
        (
        SELECT
        ...
        FROM
            GEO.TA_GG_RECUPERATION_Z_ETAPE_3 a,
            TABLE
    ...
    -- selection pour chaque sommet de son altitude apporter par la table PTTOPO dans le cas ou il ne superpose qu'avec un seul point topo.
    MERGE INTO TA_GG_RECUPERATION_Z_ETAPE_5 a
    USING 
        (
        SELECT
            a.OBJECTID_LIGNE AS OBJECTID_LIGNE,
            ...
            b.ALT AS COORD_Z
        FROM
            GEO.TA_GG_RECUPERATION_Z_ETAPE_4 a
            LEFT JOIN 
                (
                    SELECT 
    ...
    -- altitude = 0 pour tous les sommets qui ne se superpose pas à un point de la table PTTOPO
    MERGE INTO TA_GG_RECUPERATION_Z_ETAPE_6 a
    USING 
        (
        SELECT
            a.OBJECTID_LIGNE AS OBJECTID_LIGNE,
        ...
        FROM
            GEO.TA_GG_RECUPERATION_Z_ETAPE_4 a
            LEFT JOIN GEO.TA_GG_RECUPERATION_Z_ETAPE_5 b ON b.OBJECTID_LIGNE = a.OBJECTID_LIGNE
    ...
    MERGE INTO TA_GG_RECUPERATION_Z_ETAPE_7 a
    USING 
        (
        SELECT
            a.OBJECTID_LIGNE AS OBJECTID_LIGNE,
        ...
        FROM
            GEO.TA_GG_RECUPERATION_Z_ETAPE_5 a
        UNION
        SELECT
            a.OBJECTID_LIGNE as OBJECTID_LIGNE,
            a.OBJECTID_ELEMENT_LIGNE AS OBJECTID_ELEMENT_LIGNE,
            ...
            a.COORD_Z AS COORD_Z
        FROM
            GEO.TA_GG_RECUPERATION_Z_ETAPE_6 a
    ...
    MERGE INTO TA_GG_RECUPERATION_Z_ETAPE_8 a
    USING 
        (
        SELECT
            a.OBJECTID_LIGNE AS OBJECTID_LIGNE,
        ...
        FROM
            GEO.TA_GG_RECUPERATION_Z_ETAPE_7 a
        )b
    ON (a.OBJECTID_LIGNE = b.OBJECTID_LIGNE
    AND a.OBJECTID_ELEMENT_LIGNE = b.OBJECTID_ELEMENT_LIGNE
    AND a.OBJECTID_SOMMET = b.OBJECTID_SOMMET)
    ...
    MERGE INTO TA_GG_RECUPERATION_Z_ETAPE_9 a
    USING 
        (
        SELECT
            a.OBJECTID_LIGNE as OBJECTID_LIGNE,
        ...
        FROM
            GEO.TA_GG_RECUPERATION_Z_ETAPE_8 a
        GROUP BY
    ...
    MERGE INTO TA_GG_RECUPERATION_Z_ETAPE_10 a
    USING 
        (
        SELECT
            a.OBJECTID_LIGNE AS OBJECTID_LIGNE,
        ...
        FROM
            GEO.TA_GG_RECUPERATION_Z_ETAPE_2 a 
            INNER JOIN GEO.TA_GG_RECUPERATION_Z_ETAPE_9 b 
                                                        ON a.objectid_ligne = b.objectid_ligne 
                                                        AND a.objectid_element_ligne = b.objectid_element_ligne
        )b
    ON (a.OBJECTID_LIGNE = b.OBJECTID_LIGNE
    ...
    MERGE INTO TA_GG_RECUPERATION_Z_ETAPE_11 a
    USING 
        (
        SELECT
            a.OBJECTID_LIGNE,
        ...
        FROM
            GEO.TA_GG_RECUPERATION_Z_ETAPE_10 a,
            GEO.TA_GG_RECUPERATION_Z_ETAPE_1 b
        WHERE
            a.OBJECTID_LIGNE = b.OBJECTID_LIGNE
        GROUP BY
            a.OBJECTID_LIGNE,b.GEO_REF
        )b
    ON (a.OBJECTID_LIGNE = b.OBJECTID_LIGNE)
    WHEN NOT MATCHED THEN 
    INSERT(a.OBJECTID_LIGNE, a.GEO_REF, a.GEOM)
    VALUES(b.OBJECTID_LIGNE, b.GEO_REF, b.GEOM)
    ;

    -- Mise à jour du système de projection des géométrie avant la mise à jour de la table TA_LIG_TOPO_GPS
    UPDATE GEO.TA_GG_RECUPERATION_Z_ETAPE_11 a
    SET a.GEOM.SDO_SRID = 2154
    WHERE a.GEOM IS NOT NULL
    ;
    COMMIT;

    -- Insertion des nouvelles géométries dans la table TA_LIG_TOPO_GPS
    MERGE INTO TA_LIG_TOPO_GPS a
    USING 
        (
        SELECT
            ...
            a.GEOM AS GEOM
        FROM
            GEO.TA_GG_RECUPERATION_Z_ETAPE_11 a
        )b
    ON (a.OBJECTID = b.OBJECTID
    AND a.GEO_REF = b.GEO_REF)
    WHEN MATCHED THEN UPDATE SET a.GEOM = b.GEOM
    ;

COMMIT;

END MISE_A_JOUR_Z_TA_LIG_TOPO_GPS;