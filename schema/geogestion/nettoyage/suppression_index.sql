...
-- 2.2.6.2. Création d'un index sur le champ FID_IDENTIFIANT_TYPE
DROP INDEX TA_RTGE_LINEAIRE_FID_IDENTIFIANT_TYPE_IDX;

-- 3.2.6.3. Creation d'un index sur le champ FID_NUMERO_DOSSIER
DROP INDEX TA_RTGE_LINEAIRE_FID_NUMERO_DOSSIER_IDX;

-- 3.2.6.4. Creation d'un index sur le champ FID_IDENTIFIANT_OBJET_INTEGRATION
DROP INDEX TA_RTGE_LINEAIRE_FID_IDENTIFIANT_OBJET_INTEGRATION_IDX;


-- TA_RTGE_LINEAIRE_LOG

-- 3.2.6.1. Création de l'index spatial sur le champ geom
DROP INDEX TA_RTGE_LINEAIRE_LOG_SIDX;

-- 3.2.6.2. Création d'un index sur le champ FID_IDENTIFIANT_TYPE
DROP INDEX TA_RTGE_LINEAIRE_LOG_FID_IDENTIFIANT_TYPE_IDX;

-- 3.2.6.3. Creation d'un index sur le champ FID_NUMERO_DOSSIER
DROP INDEX TA_RTGE_LINEAIRE_LOG_FID_NUMERO_DOSSIER_IDX;
...
DROP INDEX TA_RTGE_POINT_FID_IDENTIFIANT_TYPE_IDX;

-- 2.1.6.3. Creation d'un index sur le champ FID_NUMERO_DOSSIER
DROP INDEX TA_RTGE_POINT_FID_NUMERO_DOSSIER_IDX;

-- 2.1.6.4. Creation d'un index sur le champ FID_NUMERO_DOSSIER
DROP INDEX TA_RTGE_POINT_FID_IDENTIFIANT_OBJET_INTEGRATION_IDX;


-- TA_RTGE_POINT_LOG

-- 3.1.6.1. Creation de l'index sur le champ GEOM
DROP INDEX TA_RTGE_POINT_LOG_SIDX;

-- 3.1.6.2. Création d'un index sur le champ FID_IDENTIFIANT_TYPE
DROP INDEX TA_RTGE_POINT_LOG_FID_IDENTIFIANT_TYPE_IDX;

-- 3.1.6.3. Creation d'un index sur le champ FID_NUMERO_DOSSIER
DROP INDEX TA_RTGE_POINT_LOG_FID_NUMERO_DOSSIER_IDX;
