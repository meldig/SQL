...
DROP TABLE TA_RTGE_POINT_LOG CASCADE CONSTRAINTS;
...
DROP TABLE TA_RTGE_LINEAIRE_LOG CASCADE CONSTRAINTS;
...
DELETE FROM USER_SDO_GEOM_METADATA WHERE TABLE_NAME = 'TA_RTGE_POINT_LOG';
...
DELETE FROM USER_SDO_GEOM_METADATA WHERE TABLE_NAME = 'TA_RTGE_LINEAIRE_LOG';
...
DROP TRIGGER B_XUD_TA_RTGE_LINEAIRE_LOG;
DROP TRIGGER B_XUD_TA_RTGE_POINT_LOG;
