...
CREATE TABLE G_GESTIONGEO.TA_OCSMEL
	(
	OBJECTID NUMBER(38,0) DEFAULT G_GESTIONGEO.SEQ_TA_OCSMEL_OBJECTID.NEXTVAL NOT NULL ENABLE, 
...
CREATE INDEX TA_OCSMEL_CREATION_IDX ON G_GESTIONGEO.TA_OCSMEL(FID_PNOM_CREATION, DATE_CREATION) TABLESPACE G_ADT_INDX;

CREATE INDEX TA_OCSMEL_MODIFICATION_IDX ON G_GESTIONGEO.TA_OCSMEL(FID_PNOM_MODIFICATION, DATE_MODIFICATION) TABLESPACE G_ADT_INDX;
...
GRANT INSERT ("GEOM") ON G_GESTIONGEO.TA_OCSMEL TO G_GESTIONGEO_MAJ;
