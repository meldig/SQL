...
COMMENT ON COLUMN G_GESTIONGEO.TA_GG_FME_DECALAGE_ABSCISSE.fid_traitement IS 'Traitement FME utilisant le CLA_INU. Clé étrangère vers la table TA_GG_TRAITEMENT_FME.';
...
ALTER TABLE G_GESTIONGEO.TA_GG_FME_DECALAGE_ABSCISSE
ADD CONSTRAINT TA_GG_FME_DECALAGE_ABSCISSE_FID_TRAITEMENT_FK
...
CREATE INDEX G_GESTIONGEO."TA_GG_FME_DECALAGE_ABSCISSE_FID_TRAITEMENT_IDX" ON G_GESTIONGEO.TA_GG_FME_DECALAGE_ABSCISSE("FID_TRAITEMENT")
