...
COMMENT ON COLUMN G_GESTIONGEO.TA_RTGE_POINT_LOG.FID_NUMERO_DOSSIER IS 'Reference du dossier pour lequel l''objet a ete releve';
COMMENT ON COLUMN G_GESTIONGEO.TA_RTGE_POINT_LOG.FID_IDENTIFIANT_TYPE IS 'Identifiant de la classe de l''objet';
...
COMMENT ON COLUMN G_GESTIONGEO.TA_RTGE_POINT_LOG.FID_PNOM_ACTION IS 'Dernier agent qui a modifie l''objet';
COMMENT ON COLUMN G_GESTIONGEO.TA_RTGE_POINT_LOG.DATE_ACTION IS 'Date de derniere action applique sur l''objet';
COMMENT ON COLUMN G_GESTIONGEO.TA_RTGE_POINT_LOG.FID_TYPE_ACTION IS 'Type de modification effectuée sur la donnée';
