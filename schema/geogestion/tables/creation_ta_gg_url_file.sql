...
COMMENT ON COLUMN G_GESTIONGEO.TA_GG_URL_FILE.FID_REPERTOIRE IS 'Clé étrangère vers la table TA_GG_REPERTOIRE pour connaitre le chemin d''accès des fichiers';
...
CREATE INDEX G_GESTIONGEO."TA_GG_URL_FILE_FID_REPERTOIRE_FICHIER_IDX" ON G_GESTIONGEO.TA_GG_URL_FILE ("FID_REPERTOIRE","FICHIER") 
    TABLESPACE G_ADT_INDX;
