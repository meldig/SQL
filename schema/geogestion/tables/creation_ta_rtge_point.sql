...
COMMENT ON COLUMN G_GESTIONGEO.TA_RTGE_POINT.FID_NUMERO_DOSSIER IS 'Reference du dossier pour lequel l''objet a ete releve';
COMMENT ON COLUMN G_GESTIONGEO.TA_RTGE_POINT.FID_IDENTIFIANT_TYPE IS 'Identifiant de la classe de l''objet';
