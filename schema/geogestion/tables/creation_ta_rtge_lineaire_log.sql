...
CREATE TABLE G_GESTIONGEO.TA_RTGE_LINEAIRE_LOG
	(
	OBJECTID NUMBER(38,0) DEFAULT G_GESTIONGEO.SEQ_TA_RTGE_LINEAIRE_LOG_OBJECTID.NEXTVAL NOT NULL ENABLE, 
...
COMMENT ON COLUMN G_GESTIONGEO.TA_RTGE_LINEAIRE_LOG.FID_IDENTIFIANT_OBJET_INTEGRATION IS 'Clé étrangère vers la table TA_RTGE_LINEAIRE_INTEGRATION_LOG. Permet d''avoir l''historique de l''objet depuis son intégration.';
