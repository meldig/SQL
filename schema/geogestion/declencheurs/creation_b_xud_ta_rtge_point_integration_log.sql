...
-- TRIGGER
    IF UPDATING THEN -- En cas de modification on insère les valeurs de la table TA_RTGE_POINT_INTEGRATION_LOG, le numéro d'agent correspondant à l'utilisateur, la date de modification et le type de modification.
        INSERT INTO G_GESTIONGEO.TA_RTGE_POINT_INTEGRATION_LOG(OBJECTID, GEOM, IDENTIFIANT_OBJET, FID_NUMERO_DOSSIER, FID_IDENTIFIANT_TYPE, TEXTE, LONGUEUR, LARGEUR, ORIENTATION, HAUTEUR, INCLINAISON, FID_PNOM_ACTION, DATE_ACTION, FID_TYPE_ACTION)
            VALUES(
            		SEQ_TA_RTGE_POINT_INTEGRATION_LOG.nextval,
            		:old.GEOM,
					:old.objectid,
