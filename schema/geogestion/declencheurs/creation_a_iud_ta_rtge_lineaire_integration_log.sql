...
SELECT 
	SEQ_TA_RTGE_LINEAIRE_INTEGRATION_LOG.nextval INTO V_OBJECTID 
FROM
	DUAL;
...
-- TRIGGER
	IF INSERTING THEN
        ...
        INSERT INTO G_GESTIONGEO.TA_RTGE_LINEAIRE_INTEGRATION_LOG(OBJECTID, GEOM, IDENTIFIANT_OBJET, FID_NUMERO_DOSSIER, FID_IDENTIFIANT_TYPE, DECALAGE_DROITE, DECALAGE_GAUCHE, FID_PNOM_ACTION, DATE_ACTION, FID_TYPE_ACTION)
            VALUES(
            		V_OBJECTID,
					:new.GEOM,
					:new.objectid,
