...
BEFORE UPDATE OF ETAT_INTEGRATION ON G_GESTIONGEO.TA_RTGE_POINT_INTEGRATION FOR EACH ROW
DECLARE
...
OBJET := :new.OBJECTID;
	...
	IF :new.ETAT_INTEGRATION = 1 THEN
		...
		INSERT INTO G_GESTIONGEO.TA_RTGE_POINT(GEOM, FID_NUMERO_DOSSIER, FID_IDENTIFIANT_TYPE, TEXTE, LONGUEUR, LARGEUR, ORIENTATION, HAUTEUR, INCLINAISON)
		VALUES (
				:new.GEOM,
