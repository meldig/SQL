...
SELECT 
	SEQ_TA_RTGE_LINEAIRE_LOG.nextval INTO V_OBJECTID 
FROM
	DUAL;
...
-- TRIGGER
    IF INSERTING THEN -- En cas de modification on insère les valeurs de la table TA_RTGE_LINEAIRE_LOG, le numéro d'agent correspondant à l'utilisateur, la date de modification et le type de modification.
        INSERT INTO G_GESTIONGEO.TA_RTGE_LINEAIRE_LOG(OBJECTID, GEOM, IDENTIFIANT_OBJET, FID_NUMERO_DOSSIER, FID_IDENTIFIANT_TYPE, DECALAGE_DROITE, DECALAGE_GAUCHE, FID_PNOM_ACTION, DATE_ACTION, FID_TYPE_ACTION, FID_IDENTIFIANT_OBJET_INTEGRATION)
            VALUES(
            		V_OBJECTID,
            		:new.GEOM,
					:new.objectid,
