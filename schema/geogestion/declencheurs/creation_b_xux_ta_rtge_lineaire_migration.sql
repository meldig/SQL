...
OBJET := :new.OBJECTID;
	...
	IF :new.integrer = 1 THEN
		-- Insertion de l''element à integrer dans la table TA_RTGE_LINEAIRE_FIN
		INSERT INTO G_GESTIONGEO.TA_RTGE_LINEAIRE_FIN(GEOM, NUMERO_DOSSIER, IDENTIFIANT_TYPE, DECALAGE_DROITE, DECALAGE_GAUCHE)
		VALUES (
				:new.GEOM,
				:new.NUMERO_DOSSIER,
