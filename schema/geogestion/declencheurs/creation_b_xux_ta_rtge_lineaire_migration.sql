...
BEFORE UPDATE OF ETAT_INTEGRATION ON G_GESTIONGEO.TA_RTGE_LINEAIRE_INTEGRATION FOR EACH ROW
DECLARE
...
OBJET := :new.OBJECTID;
	...
	IF :new.ETAT_INTEGRATION = 1 THEN
		...
		INSERT INTO G_GESTIONGEO.TA_RTGE_LINEAIRE(GEOM, FID_NUMERO_DOSSIER, FID_IDENTIFIANT_TYPE, DECALAGE_DROITE, DECALAGE_GAUCHE)
		VALUES (
				:new.GEOM,
