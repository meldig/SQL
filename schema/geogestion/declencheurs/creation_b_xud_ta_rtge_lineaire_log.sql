...
-- TRIGGER
    IF UPDATING THEN -- En cas de modification on insère les valeurs de la table TA_RTGE_LINEAIRE_LOG, le numéro d'agent correspondant à l'utilisateur, la date de modification et le type de modification.
        INSERT INTO G_GESTIONGEO.TA_RTGE_LINEAIRE_LOG(GEOM, FID_IDENTIFIANT, NUMERO_DOSSIER, IDENTIFIANT_TYPE, DECALAGE_DROITE, DECALAGE_GAUCHE, FID_PNOM_MODIFICATION, DATE_MODIFICATION, MODIFICATION)
            VALUES(
            		:old.GEOM,
					:old.objectid,
					:old.NUMERO_DOSSIER,
