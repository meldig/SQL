-- 2. Creation du trigger B_XUD_TA_RTGE_LINEAIRE_INTEGRATION_LOG
...
CREATE OR REPLACE TRIGGER G_GESTIONGEO.B_XUD_TA_RTGE_LINEAIRE_INTEGRATION_LOG
BEFORE UPDATE OR DELETE ON G_GESTIONGEO.TA_RTGE_LINEAIRE_INTEGRATION
FOR EACH ROW
DECLARE
USERNAME VARCHAR(30);
