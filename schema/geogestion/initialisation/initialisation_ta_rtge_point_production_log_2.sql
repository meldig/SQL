---------------------------------------------------
-- INITIALISATION_TA_RTGE_POINT_PRODUCTION_LOG_2 --
---------------------------------------------------

-- 4.1. Insertion des données dans la table TA_RTGE_POINT_PRODUCTION_LOG
...
USING
	(
		...
		SELECT
		    ...
		    d.OBJECTID AS FID_IDENTIFIANT_OBJET_INTEGRATION
		FROM
			G_GESTIONGEO.TEMP_TA_POINT_TOPO_F a
			LEFT JOIN G_GESTIONGEO.TA_GG_AGENT c ON TRIM(LOWER(a.GEO_NMN)) = TRIM(LOWER(c.PNOM))
		    LEFT JOIN G_GESTIONGEO.TEMP_TA_POINT_TOPO_GPS d ON a.OBJECTID = d.OBJECTID,
			CTE
		WHERE
			a.GEO_ON_VALIDE = 1
...
WHEN NOT MATCHED THEN INSERT(a.IDENTIFIANT_OBJET, a.FID_IDENTIFIANT_TYPE, a.FID_NUMERO_DOSSIER, a.GEOM, a.TEXTE, a.LONGUEUR, a.LARGEUR, a.ORIENTATION, a.HAUTEUR, a.INCLINAISON, a.FID_PNOM_ACTION, a.DATE_ACTION, a.FID_TYPE_ACTION, a.FID_IDENTIFIANT_OBJET_INTEGRATION)
VALUES(b.IDENTIFIANT_OBJET, b.FID_IDENTIFIANT_TYPE, b.FID_NUMERO_DOSSIER, b.GEOM, b.TEXTE, b.LONGUEUR, b.LARGEUR, b.ORIENTATION, b.HAUTEUR, b.INCLINAISON, b.FID_PNOM_ACTION, b.DATE_ACTION, b.FID_TYPE_ACTION, b.FID_IDENTIFIANT_OBJET_INTEGRATION)
;
