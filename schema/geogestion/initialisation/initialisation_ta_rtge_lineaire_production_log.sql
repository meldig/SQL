	...
	(
		...
		FROM
		    ...
		    LEFT JOIN G_GESTIONGEO.TA_GG_AGENT c ON TRIM(LOWER(a.GEO_NMN)) = TRIM(LOWER(c.PNOM))
   		    ...
   		    LEFT JOIN G_GESTIONGEO.TEMP_TA_LIG_TOPO_GPS d ON a.FID_IDENTIFIANT = d.OBJECTID
		    LEFT JOIN G_GESTIONGEO.TEMP_TA_LIG_TOPO_GPS_GEO_ON_VALIDE_1 e ON a.FID_IDENTIFIANT = e.OBJECTID
		    LEFT JOIN G_GESTIONGEO.TEMP_TA_LIG_TOPO_GPS_BACKUP f ON a.FID_IDENTIFIANT = f.OBJECTID
        WHERE
