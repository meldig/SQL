-- Initialisation de la table TA_RTGE_LINEAIRE_INTEGRATION_LOG
MERGE INTO G_GESTIONGEO.TA_RTGE_LINEAIRE_INTEGRATION_LOG a
USING
	(
		WITH CTE AS
			(
...
WHEN NOT MATCHED THEN INSERT(a.IDENTIFIANT_OBJET, a.FID_IDENTIFIANT_TYPE, a.FID_NUMERO_DOSSIER, a.GEOM, a.DECALAGE_DROITE, a.DECALAGE_GAUCHE, a.FID_PNOM_ACTION, a.DATE_ACTION, a.FID_TYPE_ACTION)
VALUES(b.IDENTIFIANT_OBJET, b.FID_IDENTIFIANT_TYPE, b.FID_NUMERO_DOSSIER, b.GEOM, b.DECALAGE_DROITE, b.DECALAGE_GAUCHE, b.FID_PNOM_ACTION, b.DATE_ACTION, b.FID_TYPE_ACTION)
;
