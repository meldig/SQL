...
USING
	(
		...
		WHERE
			a.GEO_ON_VALIDE =0
            AND a.geom.sdo_gtype IN (2003,2007)
            AND a.CLA_INU IN (SELECT OBJECTID FROM G_GESTIONGEO.TA_GG_CLASSE)
	) b
ON (a.OBJECTID = b.OBJECTID)
WHEN NOT MATCHED THEN INSERT(a.OBJECTID, a.IDENTIFIANT_TYPE, a.NUMERO_DOSSIER, a.GEOM, a.FID_PNOM_CREATION, a.DATE_CREATION, a.FID_PNOM_MODIFICATION, a.DATE_MODIFICATION)
VALUES (b.OBJECTID, b.IDENTIFIANT_TYPE, b.NUMERO_DOSSIER, b.GEOM, b.FID_PNOM_CREATION, b.DATE_CREATION, b.FID_PNOM_MODIFICATION, b.DATE_MODIFICATION)
;
