...
COMMENT ON TABLE GEO.V_DECOMPTE_ENTITE_CLASSE_TA_LIG_TOPO_F IS 'Vue qui comptabilise les objets valides (GEO_ON_VALIDE = 0) de la table GEO.TA_LIG_TOPO_F par classe d''objet.';
