...
-- Creation de la vue V_GG_DOSSIER afin de restituer les informations des dossiers

-- 1. Creation de la vue.
CREATE OR REPLACE FORCE VIEW G_GESTIONGEO.V_GG_DOSSIER (NUMERO_DOSSIER, TYPE_DE_DOSSIER, AVANCEMENT, DATE_CREATION, DATE_MODIFICATION, DATE_DEBUT_LEVE, DATE_FIN_LEVE, DATE_DEBUT_TRAVAUX, DATE_FIN_TRAVAUX, DATE_COMMANDE_DOSSIER, DATE_CLOTURE, MAITRE_OUVRAGE, RESPONSABLE_LEVE, ENTREPRISE_TRAVAUX, REMARQUE_GEOMETRE, REMARQUE_PHOTO_INTERPRETE, GEOM,
...
COMMENT ON TABLE G_GESTIONGEO.V_GG_DOSSIER IS 'Vue anonymisée qui présente les dossiers de l''appplication gestiongeo avec leurs informations. Les dossiers gestiongeo contiennent les périmètres des surfaces sur lesquelles les éléments urbains ont été relevés par des géomètres';
...
COMMENT ON COLUMN G_GESTIONGEO.V_GG_DOSSIER.DATE_CREATION IS 'Date de création du dossier';
