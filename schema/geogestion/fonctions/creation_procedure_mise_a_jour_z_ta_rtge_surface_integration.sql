...
/*
Cette procédure a pour objectif de corriger les altitudes des sommets des polygones de la table TA_RTGE_SURFACE.
...
CREATE OR REPLACE PROCEDURE MISE_A_JOUR_Z_TA_RTGE_SURFACE(IDENTIFIANT_DOSSIER NUMBER)
IS
BEGIN
    ...
    USING 
        ...
        FROM
            G_GESTIONGEO.TEST_RTGE_SURFACE a
        WHERE
    ...
    USING 
        ...
        FROM
            G_GESTIONGEO.TA_GG_RECUPERATION_Z_ETAPE_4 a
            INNER JOIN ALTITUDE_MOYEN c ON a.OBJECTID_LIGNE = c.OBJECTID_LIGNE
    ...
    MERGE INTO G_GESTIONGEO.TEST_RTGE_SURFACE a
    USING 
        (
        SELECT
