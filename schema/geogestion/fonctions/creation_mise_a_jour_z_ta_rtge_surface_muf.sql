CREATE OR REPLACE PROCEDURE MISE_A_JOUR_Z_TA_RTGE_SURFACE_MUF(IDENTIFIANT_DOSSIER NUMBER)
 ...
 MERGE INTO G_GESTIONGEO.TA_GG_RECUPERATION_Z_ETAPE_1 a
    USING 
        ...
        WHERE
            ...
            -- Clause pour selectionner les MUF
            AND FID_IDENTIFIANT_TYPE = 703 
        )b
    ...
    WHEN NOT MATCHED THEN 
    INSERT(a.OBJECTID, a.OBJECTID_ELEMENT, a.TYPE_WKT_LIGNE_GEOMETRY, a.TYPE_WKT_ELEMENT_GEOMETRY, a.GEOM)
    VALUES(b.OBJECTID, b.OBJECTID_ELEMENT, b.TYPE_WKT_LIGNE_GEOMETRY, b.TYPE_WKT_ELEMENT_GEOMETRY, b.GEOM)
    ;
    ...
    AND a.OBJECTID_ELEMENT = b.OBJECTID_ELEMENT)
    WHEN NOT MATCHED THEN 
    INSERT(a.OBJECTID, a.OBJECTID_ELEMENT, a.TYPE_WKT_ELEMENT_GEOMETRY, a.GEOM)
    VALUES(b.OBJECTID, b.OBJECTID_ELEMENT, b.TYPE_WKT_ELEMENT_GEOMETRY, b.GEOM)
    ;
    ...
    WHEN NOT MATCHED THEN 
    INSERT(a.OBJECTID, a.OBJECTID_ELEMENT, a.OBJECTID_SOMMET, a.COORD_X, a.COORD_Y, a.COORD_Z, a.GEOM)
    VALUES(b.OBJECTID, b.OBJECTID_ELEMENT, b.OBJECTID_SOMMET, b.COORD_X, b.COORD_Y, b.COORD_Z, b.GEOM)
    ;


    -- TA_GG_RECUPERATION_Z_ETAPE_5_MUF
    ...
    MERGE INTO G_GESTIONGEO.TA_GG_RECUPERATION_Z_ETAPE_5_MUF_TOPO a
    USING 
        (
        SELECT
            a.OBJECTID AS OBJECTID,
            ...
            b.ALT AS COORD_Z,
            SDO_GEOMETRY(3001, 2154,SDO_POINT_TYPE(a.COORD_X,a.COORD_Y,b.ALT),NULL, NULL) as GEOM
        FROM
    ...
    -- altitude = altitude du sommet le plus proche sur le meme polygone calculé à l'étape TA_GG_RECUPERATION_ETAPE_5_MUF_TOPO.
    MERGE INTO G_GESTIONGEO.TA_GG_RECUPERATION_Z_ETAPE_5_MUF_SANS_TOPO a
    USING 
        (
        SELECT
            a.OBJECTID AS OBJECTID,
            ...
            a.COORD_Y AS COORD_Y,
            null AS COORD_Z,
            SDO_GEOMETRY(3001, 2154,SDO_POINT_TYPE(a.COORD_X,a.COORD_Y,a.COORD_Z),NULL, NULL) as GEOM
        FROM
            G_GESTIONGEO.TA_GG_RECUPERATION_Z_ETAPE_4 a
        WHERE
            a.OBJECTID || a.OBJECTID_ELEMENT || a.OBJECTID_SOMMET NOT IN (SELECT a.OBJECTID || a.OBJECTID_ELEMENT || a.OBJECTID_SOMMET FROM TA_GG_RECUPERATION_Z_ETAPE_5_MUF_TOPO a)
        )b
    ON(a.OBJECTID = b.OBJECTID
    AND a.OBJECTID_ELEMENT = b.OBJECTID_ELEMENT
    AND a.OBJECTID_SOMMET = b.OBJECTID_SOMMET)
...
;
    ...
    USING 
        ...
        WITH CTE AS
            ...
            SELECT
                ...
                a.COORD_X AS COORD_X,
                a.COORD_Y AS COORD_Y,
                MIN(SDO_GEOM.SDO_DISTANCE(b.geom, a.geom, 0.001)) as distance
            FROM
                G_GESTIONGEO.TA_GG_RECUPERATION_Z_ETAPE_5_MUF_SANS_TOPO a,
                G_GESTIONGEO.TA_GG_RECUPERATION_Z_ETAPE_5_MUF_TOPO b 
            WHERE
                SDO_WITHIN_DISTANCE(a.geom, b.geom, 'distance = 0.5')= 'TRUE'
        ...
        SELECT
            ...
            a.COORD_X AS COORD_X,
            a.COORD_Y AS COORD_Y,
            b.COORD_Z AS COORD_Z
        FROM
            CTE a
            INNER JOIN G_GESTIONGEO.TA_GG_RECUPERATION_Z_ETAPE_5_MUF_SANS_TOPO c 
                    ON (a.OBJECTID=c.OBJECTID
                    AND a.OBJECTID_ELEMENT=c.OBJECTID_ELEMENT
                    AND a.OBJECTID_SOMMET=c.OBJECTID_SOMMET)
            INNER JOIN G_GESTIONGEO.TA_GG_RECUPERATION_Z_ETAPE_5_MUF_TOPO b ON SDO_GEOM.SDO_DISTANCE(b.geom, c.geom, 0.001)= a.DISTANCE
        )b
    ON (a.OBJECTID = b.OBJECTID
    AND a.OBJECTID_ELEMENT = b.OBJECTID_ELEMENT
    AND a.OBJECTID_SOMMET = b.OBJECTID_SOMMET)
    WHEN NOT MATCHED THEN 
    INSERT(a.OBJECTID, a.OBJECTID_ELEMENT, a.OBJECTID_SOMMET, a.COORD_X, a.COORD_Y, a.COORD_Z)
    VALUES(b.OBJECTID, b.OBJECTID_ELEMENT, b.OBJECTID_SOMMET, b.COORD_X, b.COORD_Y, b.COORD_Z)
    ;
    ...
    USING 
        ...
        FROM
            G_GESTIONGEO.TA_GG_RECUPERATION_Z_ETAPE_5_MUF_TOPO a
        UNION
        SELECT
            a.OBJECTID as OBJECTID,
            a.OBJECTID_ELEMENT AS OBJECTID_ELEMENT,
    ...
    AND a.OBJECTID_SOMMET = b.OBJECTID_SOMMET)
    WHEN NOT MATCHED THEN 
    INSERT(a.OBJECTID, a.OBJECTID_ELEMENT, a.OBJECTID_SOMMET, a.GEOM)
    VALUES(b.OBJECTID, b.OBJECTID_ELEMENT, b.OBJECTID_SOMMET, b.GEOM)
    ;
    ...
    USING 
        ...
        GROUP BY
            a.OBJECTID, a.OBJECTID_ELEMENT
        )b
    ON (a.OBJECTID = b.OBJECTID
    AND a.OBJECTID_ELEMENT = b.OBJECTID_ELEMENT)
    WHEN NOT MATCHED THEN 
    INSERT(a.OBJECTID, a.OBJECTID_ELEMENT, a.GEOM)
    VALUES(b.OBJECTID, b.OBJECTID_ELEMENT, b.GEOM)
    ;
    ...
    DELETE FROM TA_GG_RECUPERATION_Z_ETAPE_4;
    DELETE FROM TA_GG_RECUPERATION_Z_ETAPE_5_MUF_SANS_TOPO;
    DELETE FROM TA_GG_RECUPERATION_Z_ETAPE_5_MUF_TOPO;

COMMIT;

END MISE_A_JOUR_Z_TA_RTGE_SURFACE_MUF;
