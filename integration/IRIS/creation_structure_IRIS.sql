...
COMMENT ON TABLE ta_iris IS 'Table regroupant les zones IRIS';
COMMENT ON COLUMN ta_iris.objectid IS 'Clé primaire de la table TA_BPE.';
COMMENT ON COLUMN ta_iris.fid_code IS 'Clé étrangère vers la table TA_CODE pour connaitre le code de la zone IRIS.';
COMMENT ON COLUMN ta_iris.fid_nom IS 'Clé étrangère vers la table TA_NOM pour connaitre le nom de la zone IRIS.';
COMMENT ON COLUMN ta_iris.fid_libelle IS 'Clé étrangère vers la table TA_LIBELLE pour connaitre le type de zone IRIS.';
COMMENT ON COLUMN ta_iris.fid_metadonnee IS 'Clé étrangère vers la table TA_METADONNE pour connaitre la source et le millesime de la zone IRIS.';
COMMENT ON COLUMN ta_iris.fid_iris_geom IS 'Clé étrangère vers la table TA_IRIS_GEOM pour connaitre la géométrie de la zone IRIS.';
...
ALTER TABLE ta_iris
ADD CONSTRAINT ta_iris_fid_libelle_FK 
...
CREATE INDEX ta_iris_fid_libelle_IDX ON ta_iris(fid_libelle)
TABLESPACE G_ADT_INDX;
...
COMMENT ON TABLE TA_IRIS_GEOM IS 'Table regroupant les zones IRIS';
COMMENT ON COLUMN TA_IRIS_GEOM.objectid IS 'Clé primaire de la table TA_BPE.';
COMMENT ON COLUMN TA_IRIS_GEOM.geom IS 'Géométrie de la zone IRIS.';
