/*
Requêtes nécessaires à la création des tables temporaires servant a créer la vue matérialisée G_REFERENTIEL.ADMIN_IRIS.
La vue materialisée G_REFERENTIEL.ADMIN_IRIS a pour but de restituer les données IRIS aux millesimes le plus récent.
*/
