-- Requête de création des tables nécessaires à l'insertion des données IRIS
...
-- 2. Creation de la table TA_IRIS qui recense les zones IRIS.
...
COMMENT ON COLUMN ta_iris.fid_lib_type IS 'Clé étrangère vers la table TA_LIBELLE pour connaitre le type de zone IRIS.';
...
CREATE INDEX ta_iris_fid_lib_type_IDX ON ta_iris(fid_lib_type)
    TABLESPACE G_ADT_INDX;
