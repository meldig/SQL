...
USING
	(
	SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/2017','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/2016','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/2015','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/2014','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/2013','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/2012','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/2011','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/2010','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/2009','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/2008','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/2007','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/2006','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/1999','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/1990','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/1982','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/1975','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/1968','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/1962','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/1954','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/1936','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/1931','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/1926','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/1921','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/1911','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/1906','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/1901','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/1896','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/1891','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/1886','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/1881','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	UNION SELECT TO_DATE(SYSDATE,'dd/mm/yy') AS DATE_ACQUISITION, TO_DATE('01/01/1876','dd/mm/yy') AS MILLESIME, SYS_CONTEXT('USERENV','OS_USER') AS NOM_OBTENTEUR FROM DUAL
	) b
ON (
