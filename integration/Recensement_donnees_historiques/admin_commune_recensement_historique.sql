...
ALTER MATERIALIZED VIEW G_REFERENTIEL.ADMIN_COMMUNE_RECENSEMENT_HISTORIQUE 
...
CREATE INDEX vm_admin_commune_recensement_historique_code_insee_nom_recensement ON G_REFERENTIEL.ADMIN_COMMUNE_RECENSEMENT_HISTORIQUE (CODE_INSEE, NOM, RECENSEMENT)
TABLESPACE G_ADT_INDX
;