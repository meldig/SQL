...
COMMENT ON COLUMN g_geo.ta_recensement.fid_recensement IS 'Clé étrangère vers la table TA_LIBELLE_COURT pour connaitre le recensement concerné.';
...
-- 4.2 Clé étrangère du champ fid_recensement vers la table ta_libelle_court
