/*
La table ta_recensement regroupe toutes les valeurs des différents recensement comptabilisees par les communes composant la MEL entre 1876 et 2017
...
COMMENT ON COLUMN ta_recensement.fid_recensement IS 'Clé étrangère vers la table TA_LIBELLE_COURT pour connaitre la date du recensement.';
...
ta_recensement
ADD CONSTRAINT
ta_recensement_fid_recensement_FK
FOREIGN KEY
(fid_recensement)
REFERENCES
ta_libelle_court(objectid);
...
ta_recensement
ADD CONSTRAINT
ta_recensement_fid_metadonnee_FK
FOREIGN KEY
(fid_metadonnee)
REFERENCES
ta_metadonnee(objectid);
