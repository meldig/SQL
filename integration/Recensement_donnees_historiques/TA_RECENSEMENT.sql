...
COMMENT ON COLUMN ta_recensement.fid_recensement IS 'Clé étrangère vers la table TA_LIBELLE pour connaitre le recensement concerné par la valeur du nombre d''habitant.';
...
-- 4.2 Clé étrangère du champ fid_recensement vers la table ta_libelle
ALTER TABLE 
ta_recensement
ADD CONSTRAINT
