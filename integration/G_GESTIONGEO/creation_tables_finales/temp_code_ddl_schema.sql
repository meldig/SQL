...
BEGIN
    ...
    EXCEPTION
        WHEN OTHERS THEN
            mail.sendmail('bjacq@lillemetropole.fr','L''erreur ' || SQLERRM || v_message,'ERREUR TRIGGER - G_GESTIONGEO.A_IUD_TA_GG_DOSSIER_LOG','bjacq@lillemetropole.fr');
END;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON G_GESTIONGEO.V_VALEUR_TRAITEMENT_FME TO G_GESTIONGEO_RW;
GRANT SELECT, INSERT, UPDATE, DELETE ON G_GESTIONGEO.V_VALEUR_GESTION_TRAITEMENT_FME TO G_GESTIONGEO_RW;