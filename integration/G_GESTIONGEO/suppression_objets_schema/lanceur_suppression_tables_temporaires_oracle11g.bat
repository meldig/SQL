@echo off
echo Bienvenu dans la suppression des tables temporaires ayant servi a corriger les tables GestionGeo dans Oracle 11g !
...
sqlplus.exe %USER%/%MDP%@%INSTANCE% @%chemin_code_ddl%\suppression_tables_temporaires_oracle11g.sql
pause