...
MERGE INTO G_GESTIONGEO.TA_GG_URL_FILE a
USING (
    SELECT
...
INSERT (a.OBJECTID, a.FID_DOSSIER, a.DOS_URL_FILE, a.INTEGRATION)
VALUES (b.OBJECTID, b.FID_DOSSIER, b.DOS_URL_FILE, b.INTEGRATION)
;
COMMIT;

-- 1.2. Suppression de la séquence
DROP SEQUENCE SEQ_TA_GG_URL_FILE_OBJECTID;

-- 1.3. Creation de la séquence à la bonne valeur de depart.
SET SERVEROUTPUT ON
DECLARE
    ...
    -- Création de la séquence du trigger pour TEMP_TA_GG_GEO
        EXECUTE IMMEDIATE 'CREATE SEQUENCE SEQ_TA_GG_URL_FILE_OBJECTID INCREMENT BY 1 START WITH ' || v_new_id;
    END;

    /

-- 12. AJOUT DES GUILLEMETS DANS LA COLONNE LIEN
UPDATE G_GESTIONGEO.TEMP_LISTE_FICHIER_GESTION_GEO
SET LIEN = '"' || LIEN || '"';
COMMIT;

-- 13. AJOUT DES GUILLEMETS DANS LA COLONNE LIEN
UPDATE G_GESTIONGEO.TEMP_LISTE_FICHIER_GESTION_GEO
SET LIEN_RENOMMAGE_FICHIER = '"' || LIEN_RENOMMAGE_FICHIER || '"';
COMMIT;

-- 14. AJOUT DES GUILLEMETS DANS LA COLONNE LIEN
UPDATE G_GESTIONGEO.TEMP_LISTE_FICHIER_GESTION_GEO
SET DOSSIER = '"' || DOSSIER || '"';
COMMIT;
