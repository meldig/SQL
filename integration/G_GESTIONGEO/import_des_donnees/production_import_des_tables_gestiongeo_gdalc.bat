...
ogr2ogr.exe -f OCI OCI:%USER_D%/%MDP_D%@%INSTANCE_D% OCI:%USER_P%/%MDP_P%@%INSTANCE_P% -sql "SELECT * FROM G_GESTIONGEO.TA_GG_FAMILE" -nln TA_GG_FAMILE
...
:: 5.12. table TA_GG_GEO
ogr2ogr.exe -f OCI OCI:G_DALC/imptadmd@multit OCI:G_GESTIONGEO/ad1mgestiongeod?@multit -sql "SELECT * FROM G_GESTIONGEO.TA_GG_GEO" -nlt POLYGON -lco SRID=2154 -dim 2 -lco GEOMETRY_NAME=GEOM -nln TA_GG_GEO
