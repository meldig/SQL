...
-- 6. Création de la séquence du trigger pour TEMP_TA_GG_GEO
    EXECUTE IMMEDIATE 'CREATE SEQUENCE SEQ_TEMP_TA_GG_GEO INCREMENT BY 1 START WITH ' || v_new_id;
END;

/

-- 7. Création du trigger d'incrémentation de la PK de TEMP_TA_GG_GEO
...
-- 8. Création de la séquence du trigger pour TEMP_TA_GG_DOSSIER
    EXECUTE IMMEDIATE 'CREATE SEQUENCE SEQ_TEMP_TA_GG_DOSSIER INCREMENT BY 1 START WITH ' || v_new_id;
END;

/

-- 9. Création du trigger d'incrémentation de la PK de TEMP_TA_GG_DOSSIER
