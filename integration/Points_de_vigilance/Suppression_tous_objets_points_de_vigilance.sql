...
Requêtes permettant la suppression de tous les objets, et donc des données, liés aux points de vigilance (tables, contraintes, déclencheurs).
	1. Suppression de la table pivot permettant d'associer un point de vigilance à un permis de construire ;
	2. Suppression de la table des permis de construire ;
	3. Suppression de la table d'audit ;
	4. Suppression de la table des points de vigilance et de ses métadonnées spatiales ;
*/
