DELETE FROM user_sdo_geom_metadata WHERE table_name = 'VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE';
DROP INDEX VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE_SIDX;
DROP INDEX VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE_IDENTIFIANT_IDX;
DROP INDEX VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE_TYPE_ERREUR_IDX;
DROP INDEX VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE_REQUETE_IDX;
DROP MATERIALIZED VIEW VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE;

----------------------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------3. Création de la VM VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE-----------------------------------------
----------------------------------------------------------------------------------------------------------------------------------------------------

-- Creation d'une vue pour afficher les polygones OCS2D avec des évolutions improbable
--1. Creation
CREATE MATERIALIZED VIEW G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE
    (
    OBJECTID,
    IDENTIFIANT,
    TYPE_ERREUR,
...
-- 2. Commentaire
COMMENT ON MATERIALIZED VIEW G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE IS 'Vue qui présente les évolutions improbables';
COMMENT ON COLUMN G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE.OBJECTID IS 'Clé primaire de la VM';
COMMENT ON COLUMN G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE.IDENTIFIANT IS 'Identifiant du polygone';
COMMENT ON COLUMN G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE.TYPE_ERREUR IS 'Type d''observation faite sur l''évolution du polygone entre les millesimes 2015 et 2020';
COMMENT ON COLUMN G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE.REQUETE IS 'Code observée entre les deux millesimes';
COMMENT ON COLUMN G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE.GEOM IS 'Géomtrie du polygones';

-- 1.3. Création de la clé primaire
ALTER MATERIALIZED VIEW G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE
ADD CONSTRAINT VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE_PK 
...
VALUES(
    'VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE',
    'GEOM',
...
CREATE INDEX VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE_SIDX
ON G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE(GEOM)
INDEXTYPE IS MDSYS.SPATIAL_INDEX
PARAMETERS('sdo_indx_dims=2, layer_gtype=MULTIPOLYGON, tablespace=G_ADT_INDX, work_tablespace=DATA_TEMP');


-- 5. INDEX
CREATE INDEX VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE_IDENTIFIANT_IDX ON G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE(IDENTIFIANT)
    TABLESPACE G_ADT_INDX;

CREATE INDEX VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE_TYPE_ERREUR_IDX ON G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE(TYPE_ERREUR)
    TABLESPACE G_ADT_INDX;

CREATE INDEX VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE_REQUETE_IDX ON G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE(REQUETE)
    TABLESPACE G_ADT_INDX;

-- 6. Affectation du droit de sélection sur les objets de la table aux administrateurs
GRANT SELECT ON G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE TO G_ADMIN_SIG;

----------------------------------------------------------------------------------------------------------------------------------------------------
------------------------------------------------------4. Création de la VM VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE_OCCURENCE----------------------------------
----------------------------------------------------------------------------------------------------------------------------------------------------
DROP MATERIALIZED VIEW VM_OCS2D_EVOLUTION_IMPROBABLE_OCCURENCE_LIVRAISON_FINALE_CORRIGEE;

--1. Création de la vue matérialisée 
CREATE MATERIALIZED VIEW G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_OCCURENCE_LIVRAISON_FINALE_CORRIGEE
    (
    OBJECTID,
    OCCURENCE,
    REQUETE
...
-- 2. Commentaire
COMMENT ON MATERIALIZED VIEW G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_OCCURENCE_LIVRAISON_FINALE_CORRIGEE IS 'Vue qui présente les occurrences des évolutions improbables de la vue V_OCS2D_EVOLUTION_IMPROBABLE';
COMMENT ON COLUMN G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_OCCURENCE_LIVRAISON_FINALE_CORRIGEE.OBJECTID IS 'Clé primaire de la table';
COMMENT ON COLUMN G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_OCCURENCE_LIVRAISON_FINALE_CORRIGEE.OCCURENCE IS 'Nombre d''occurence de l''observation';
COMMENT ON COLUMN G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_OCCURENCE_LIVRAISON_FINALE_CORRIGEE.REQUETE IS 'Requete executee';

-- 4. Affection du droit de lecture aux admins
GRANT SELECT ON G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_OCCURENCE_LIVRAISON_FINALE_CORRIGEE TO G_ADMIN_SIG;
...
GRANT SELECT ON G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_LIVRAISON_FINALE_CORRIGEE TO G_OCS2D_R;
GRANT SELECT ON G_OCS2D.VM_OCS2D_EVOLUTION_IMPROBABLE_OCCURENCE_LIVRAISON_FINALE_CORRIGEE TO G_OCS2D_R;