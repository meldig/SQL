...
COMMENT ON COLUMN ta_ocs2d.cs IS 'Clé étrangère vers la table TA_LIBELLE';
COMMENT ON COLUMN ta_ocs2d.us IS 'Clé étrangère vers la table TA_LIBELLE';
COMMENT ON COLUMN ta_ocs2d.indice IS 'Clé étrangère vers la table TA_OCS2D_INDICE';
COMMENT ON COLUMN ta_ocs2d.source IS 'Clé étrangère vers la table TA_OCS2D_SOURCE';
COMMENT ON COLUMN ta_ocs2d.metadonnee IS 'Clé étrangère vers la table TA_METADONNEE';
COMMENT ON COLUMN ta_ocs2d.geom IS 'Clé étrangère vers la table TA_OCS2D_GEOM';
