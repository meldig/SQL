...
/*
1. Creation des vues matérialisées successives pour créer la vue matérialisée VM_ADMIN_OCS2D_MULTIDATE_MEL.
*/
...
-- 4. Creation des commentaires de la vues materialisée VM_ADMIN_OCS2D_MULTIDATE_MEL
...
-- 4.2. Commentaires sur les colonnes VM_ADMIN_OCS2D_MULTIDATE_MEL
...
COMMENT ON COLUMN G_OCS2D.VM_ADMIN_OCS2D_MULTIDATE_MEL."21_P_20" IS 'Poste de la nomenclature 21 postes à laquelle appartient la combinisaison CS/US du polygone en 2020';
