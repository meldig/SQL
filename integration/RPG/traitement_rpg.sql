...
EXECUTE IMMEDIATE 'ALTER TABLE G_ADT_AGRI.RPG_PARC_INSTRUITES_2019_MEL DROP CONSTRAINT ' || v_nom;
END;
/
...
EXECUTE IMMEDIATE 'ALTER TABLE G_ADT_AGRI.RPG_FORMEJURIDIQUE_2019_MEL DROP CONSTRAINT ' || v_nom;
END;
/
...
EXECUTE IMMEDIATE 'ALTER TABLE G_ADT_AGRI.RPG_ILOTS_DESCRIPTION_2019_MEL DROP CONSTRAINT ' || v_nom;
END;
/
...
EXECUTE IMMEDIATE 'ALTER TABLE G_ADT_AGRI.RPG_AIDES_2ND_PILIER_2019_MEL DROP CONSTRAINT ' || v_nom;
END;
/
...
EXECUTE IMMEDIATE 'ALTER TABLE G_ADT_AGRI.RPG_AIDES_1ER_PILIER_2019_MEL DROP CONSTRAINT ' || v_nom;
END;
/
