@echo off
echo Bienvenu dans l insertion des communes associees de la nouvelle BdTopo en base !
...
SET /p chemin_normalisation="Veuillez saisir le chemin d'accès du dossier contenant la requêtes d insertion des communes associees de la nouvelle BdTopo : "  
...
sqlplus.exe %USER%/%MDP%@%INSTANCE% @%chemin_normalisation%\maj_communes_associees_nouvelle_bdtopo.sql
pause