...
ogr2ogr -f OCI -append -sql "SELECT INSEE_COM, NATURE, NOM FROM COMMUNE_ASSOCIEE_OU_DELEGUEE WHERE SUBSTR(INSEE_COM,0,2) = '59'" OCI:%USER%/%MDP%@%INSTANCE% %chemin_insertion%\59\donnees\ADMINISTRATIF\COMMUNE_ASSOCIEE_OU_DELEGUEE.shp -nln TEMP_COMMUNE_ASSOCIEE_OU_DELEGUEE -lco SRID=2154 -dim 2
