@echo off
echo Bienvenu dans l insertion des donnees des communes de la nouvelle BdTopo en base !
...
SET /p chemin_normalisation="Veuillez saisir le chemin d'accès du dossier contenant la requêtes d insertion des communes de la nouvelle BdTopo : "  
