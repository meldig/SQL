...
COMMENT ON COLUMN ta_libelle.objectid IS 'Identifiant de chaque ligne.';
COMMENT ON COLUMN ta_libelle.fid_famille IS 'Identifiant de chaque famille de libellés - FK de la table ta_famille.';
COMMENT ON COLUMN ta_libelle.fid_libelle IS 'Identifiant de chaque libellés - FK de la table ta_libelle.';
