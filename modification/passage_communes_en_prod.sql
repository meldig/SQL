...
-- 4.3. insertion des fid_libelle_long dans ta_libelle;
...
FROM
    ta_commune a
    INNER JOIN ta_nom b ON a.fid_nom = b.objectid
    INNER JOIN communes c ON b.valeur = c.nom
...
FROM
	...
	INNER JOIN ta_libelle e ON d.fid_libelle = e.objectid
    INNER JOIN ta_libelle_long f ON e.fid_libelle_long = f.valeur
WHERE
	f.valeur = 'code insee'
