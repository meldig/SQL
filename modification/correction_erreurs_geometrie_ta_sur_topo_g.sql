...
DECLARE
BEGIN
SAVEPOINT POINT_SAVE_TEST_SUR_TOPO_G;

/*
Cette procédure a pour objectif de corriger les erreurs de géométrie présentes dans la table TEST_SUR_TOPO_G.
...
EXCEPTION
    WHEN OTHERS THEN
        ...
        ROLLBACK TO POINT_SAVE_TEST_SUR_TOPO_G;
END;